...
// 新建组件
const ResultDetailUpdateForm = Form.create()(props => {
  const { modalDetailVisible, form,handleModalDetailVisible,modalDetailInfo,handleDetailUpdate} = props;
  const okHandle = () => {
    form.validateFields((err, fieldsValue) => {
      if (err) return;
      handleDetailUpdate(fieldsValue);
      handleModalDetailVisible(false);
    });
  };
...
class ResultDetail extends PureComponent {
    ...
    },
    {
        ...
        render: (text, record) => (
          <Fragment>
            ...
            <a onClick={() => this.modifyDetailItem( true,text)}>设定</a>  &nbsp;&nbsp;
  ...
  modifyDetailItem =(flag,text)=>{
    this.handleModalDetailVisible(flag);
    this.setState({ modalDetailInfo:text})
  };
  ...
  handleDetailUpdate =(fieldsValue)=>{
      let params = this.state.modalDetailInfo;
      const reportno = sessionStorage.getItem('reportno');
      params.refervalue = fieldsValue.refervalue;
  ...
  render() {
    ...
    const { targetStandards , selectedStandards , standards , instrument , targetInstrument ,
      selectedInstrument ,people,targetPeople,selectedPeople,modalInfo,modalReviewVisible,modalDetailVisible,modalDetailInfo,modalType} = this.state;
    const parentMethods = {
      handleModalReviewVisible:this.handleModalReviewVisible,
      handleModalDetailVisible:this.handleModalDetailVisible,
    ...
    return (
      <PageHeaderWrapper text={reprotText}>
        ...
        <ResultDetailUpdateForm {...parentMethods} modalDetailVisible={modalDetailVisible} modalDetailInfo={modalDetailInfo} />
        <Modal
          title="结果登记"
